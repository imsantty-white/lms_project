...
// Componente EditModuleModal usando Dialog
...
// - initialData: objeto con los datos actuales del módulo a editar ({ _id, nombre, descripcion, orden })
...
function EditModuleModal({ open, onClose, onSubmit, initialData, isSaving }) {
  ...
  const handleSubmit = (event) => {
    ...
    const updatedData = {
      // Incluimos el ID del módulo para que el componente padre sepa cuál actualizar
  ...
  return (
    ...
    >
      {/* Título del modal */}
      <DialogTitle id="edit-module-modal-title">
        Editar Módulo
      </DialogTitle>
